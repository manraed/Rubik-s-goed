...
char find_edgepiece(char, char, char[6][9]);
char find_corner_piece(char a, char b, char c, char[6][9]);
void bringdownedge(char a, char b, char[6][9]);

void wit_blauw_rood_inschuiven(char cp1, char[6][9]);
void wit_blauw_oranje_inschuiven(char cp2, char[6][9]);
void wit_groen_rood_inschuiven(char cp2, char[6][9]);
void wit_groen_oranje_inschuiven(char cp2, char[6][9]);

void solve_middle_layer(char[6][9]);
char midden_test(char[6][9]);
void recht_midden_plaatsen(char[6][9]);
void links_midden_plaatsen(char[6][9]);
void midden_indraaien(char[6][9]);
char find_good_edge_piece(char[6][9]);

void maak_geel_kruis(char[6][9]);
char maak_geel_tussenstap(char[6][9]);
